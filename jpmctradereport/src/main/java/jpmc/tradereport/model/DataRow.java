...
public class DataRow {
	...
	// respect to Instruction LocalDate
	// The only non-final since it can be recalculated from business logic.
	private LocalDate settlementDate;

	private final DataRowDetail details;

	public DataRow(String entity, TradeAction action, LocalDate instructionDate, LocalDate settlementDate,
			DataRowDetail details) {
		this.entity = entity;
		this.action = action;
	...
	public DataRowDetail getDetails() {
		return details;
	}
